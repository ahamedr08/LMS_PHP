...
<body>
    ...
    <div style=" width: 100%; height: 50px; margin-top: -20px">
	  ...
	  {
		echo "<tr style='color: black; width: 350px; margin-top: 0px; float: left;'>";
  ...
  document.body.style.backgroundColor = "white";
	...
	<?php
		...
		if(isset($_POST['submit']))
		{
			...
			$q=mysqli_query($db,"SELECT * from books where name like '%$_POST[search]%' and 
...
?>
					<script type="text/javascript">
						alert("The book is not available now in the library.");
					</script>
				<?php
}
}
