...
<div id="main">
  <span style="font-size:30px;cursor:pointer; color: black;font-family: Times new roman;" onclick="openNav()">&#9776; OPEN</span>
  <div class="container" style="text-align: center;">
    <h2 style="color:white; font-family: Times new roman; text-align: center"><b>Add New Books</b></h2><br>
...
<?php
    if(isset($_POST['submit']))
    {
      if(isset($_SESSION['login_user']))
      {
        ...
        '$_POST[status]', '$_POST[quantity]', '$_POST[department]','0') ;");       ?>
