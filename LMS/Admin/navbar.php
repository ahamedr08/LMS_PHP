...
<body>
<?php
  $r=mysqli_query($db,"SELECT COUNT(status) AS total FROM message where 
  status='no' and sender='student';");
  $c=mysqli_fetch_assoc($r);
  $sql_app=mysqli_query($db,"SELECT COUNT(status) AS total FROM admin where 
  status='';");
