...
<section>
  <div class="log_img">
   <br>
    <div class="box1">
        <h1 style="text-align: center; font-size: 35px;font-family:Times new roman;">Library Management System</h1>
        <h1 style="text-align: center; font-size: 25px;font-family:Times new roman">User Login Form</h1><br>
      <form  name="login" action="" method="post">
      <b><p style="padding-left: 50px; font-size: 25px; font-width: 700; font-family: Times new roman;"> Login as : </p></b>
      <input style="margin-left: 50px; width: 18px; font-family: Times new roman;" type="radio" name="user" id="admin" value="admin">
      <label for="admin">Admin</label>
      <input style="margin-left: 50px; width: 18px; font-family: Times new roman;" type="radio" name="user" id="student" value="student">
